...
?>
	...
	$('#s_basic').click(function(){
		...
		$('#spCheckbox').prop('checked', false);
		$('#thesisCheckbox').prop('checked', false);
		$('#cdCheckbox').prop('checked', false);
		$('#magazineCheckbox').prop('checked', false);
		$('#referenceCheckbox').prop('checked', false);
		//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
