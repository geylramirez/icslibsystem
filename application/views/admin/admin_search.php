                        ...
                        echo "<table id='myTable' class = 'table table-hover table-bordered'>
                            <thead>
                                <tr>
                                    ...
                                    <th style='width:48%;'><center>Library Information</center></th>
                                    <th style='width:8%;'><center>Req.</center></th>
                                    <th style='width:5%;'><center>Available Copies</center></th>
                                    <th style='width:11%;'><b><center>Action</center></b></th>
                                </tr>
                            </thead>";
                                if($flag->num_rows()==0){
                                	echo "<tbody>";
                                    ...
                                    foreach ($sql2->result() as $q){
										...
										echo "<tr id = '{$q->materialid}'>";
											...
											echo "</td>";
												...
												echo "<button type='submit' class='pull-left updateButton btn btn-default btn-sm' name='update'><span class='glyphicon glyphicon-edit'></button></form>";
												echo "<button onclick = 'deleteBook($(this))' class='deleteButton btn btn-danger btn-sm' name='return'><span class='glyphicon glyphicon-remove'></button>";
												echo "</td></tr>";
											}
                                       	echo "</tbody>";
                                    }
