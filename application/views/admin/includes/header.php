         ...
         <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a  href="<?php echo base_url();?>admin/home" class="navbar-brand" style = "cursor: pointer;"><img src="<?php echo base_url();?>dist/images/icslogo.png" height="40px;" > ICS Library - Admin Dashboard</a>
                </div>
